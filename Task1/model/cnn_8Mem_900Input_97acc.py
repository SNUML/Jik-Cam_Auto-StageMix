...
for i in range(3):
    for j in range(3):
        if(j==0):
            Picture = np.load('./_picMixed_'+str(j)+'_'+str(i)+'.npy')
            Label = np.load('./_lblMixed_'+str(j)+'_'+str(i)+'.npy')
        else:
            Picture = np.append(Picture,np.load('./_picMixed_'+str(j)+'_'+str(i)+'.npy'),axis=0)
            Label = np.append(Label,np.load('./_lblMixed_'+str(j)+'_'+str(i)+'.npy'),axis=0)
